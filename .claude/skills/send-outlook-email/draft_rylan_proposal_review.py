"""Final Rylan email with all latest edits incorporated."""
...
<p>Working on the revised Hilger-Roy LiDAR proposal for Fergus and want your eyes on it before I send. Way more meat than the October version &mdash; $86K total versus the $55.5K we bid in October. Melanie&rsquo;s KML of the new alignment is attached.</p>

<h3 style="margin-bottom:4px;">Scope Changes Since October</h3>
<p>As you know, the original was an unclassified LAS plus planimetric CAD extraction. HDR now wants a fully classified LAS per their 24-class feature codes, an ECW ortho, and an ASPRS accuracy report. That classification work is most of the price jump.</p>
...
<h3 style="margin-bottom:4px;">Fee Breakdown ($86K total, ~508 hours)</h3>
...
<tr><td style="padding:4px 10px;border:1px solid #ccc;">1. PM / Admin / QA-QC</td><td style="padding:4px 10px;border:1px solid #ccc;">40</td><td style="padding:4px 10px;border:1px solid #ccc;">$6,720</td><td style="padding:4px 10px;border:1px solid #ccc;">&mdash;</td><td style="padding:4px 10px;border:1px solid #ccc;">$6,720</td></tr>
<tr><td style="padding:4px 10px;border:1px solid #ccc;">2. Pre-field Prep</td><td style="padding:4px 10px;border:1px solid #ccc;">34</td><td style="padding:4px 10px;border:1px solid #ccc;">$5,288</td><td style="padding:4px 10px;border:1px solid #ccc;">&mdash;</td><td style="padding:4px 10px;border:1px solid #ccc;">$5,288</td></tr>
<tr><td style="padding:4px 10px;border:1px solid #ccc;">3. Field Work (acquisition + checkpoints)</td><td style="padding:4px 10px;border:1px solid #ccc;">124</td><td style="padding:4px 10px;border:1px solid #ccc;">$17,591</td><td style="padding:4px 10px;border:1px solid #ccc;">$10,674</td><td style="padding:4px 10px;border:1px solid #ccc;">$28,265</td></tr>
<tr><td style="padding:4px 10px;border:1px solid #ccc;">4. Processing (trajectory, georef, ortho)</td><td style="padding:4px 10px;border:1px solid #ccc;">54</td><td style="padding:4px 10px;border:1px solid #ccc;">$9,072</td><td style="padding:4px 10px;border:1px solid #ccc;">&mdash;</td><td style="padding:4px 10px;border:1px solid #ccc;">$9,072</td></tr>
<tr><td style="padding:4px 10px;border:1px solid #ccc;">5. Classification (the big bucket)</td><td style="padding:4px 10px;border:1px solid #ccc;">201</td><td style="padding:4px 10px;border:1px solid #ccc;">$27,832</td><td style="padding:4px 10px;border:1px solid #ccc;">&mdash;</td><td style="padding:4px 10px;border:1px solid #ccc;">$27,832</td></tr>
<tr><td style="padding:4px 10px;border:1px solid #ccc;">6. Deliverables &amp; client review</td><td style="padding:4px 10px;border:1px solid #ccc;">55</td><td style="padding:4px 10px;border:1px solid #ccc;">$8,604</td><td style="padding:4px 10px;border:1px solid #ccc;">&mdash;</td><td style="padding:4px 10px;border:1px solid #ccc;">$8,604</td></tr>
<tr style="background:#fffae6; font-weight:bold;"><td style="padding:4px 10px;border:1px solid #ccc;">TOTAL</td><td style="padding:4px 10px;border:1px solid #ccc;">508</td><td style="padding:4px 10px;border:1px solid #ccc;">$75,107</td><td style="padding:4px 10px;border:1px solid #ccc;">$10,674</td><td style="padding:4px 10px;border:1px solid #ccc;">$86,000</td></tr>
</table>
<p style="margin-top:8px;">Phase 3 expenses include $9,900 for the MiniRanger-3 Lite equipment fee (built into the total, not on top), 600 mi mileage @ $0.75, and 6 per-diem days @ $54.</p>
...
<li><b>Manual cleanup and reconciliation.</b> Smaller stuff (signs 831, light poles 858, bridges 895) bundled in Row 61. Traffic signals (840) likely zero on this corridor. Target &lt;5% of the site needing manual touch. <b>Row 66 LAS QA pass = 13 hrs.</b></li>
</ol>

<h3 style="margin-bottom:4px;">What We&rsquo;re Delivering and Software</h3>
<p><b>Deliverables to HDR:</b></p>
<ul>
<li>Classified LAS v1.4 point cloud per HDR&rsquo;s 24-class feature codes &mdash; two products: fully classified at native density, plus a thinned ground product at ~1 pt/m&sup2; for clean ground surface and contour generation</li>
...
<p>Workbook is at <code>\\Stahly\marketing\Scope-Schedule-Budget\Survey - GIS\2025\Great Falls\036-Fergus_Electric_Lidar\</code>. Proposal docx in the same folder.</p>
...
print("Draft opened with KML attached.")
